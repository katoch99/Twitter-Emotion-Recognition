...
Analytics provides with essential knowledge about the social media performance. They tell about metrics such as:
•	engagement rate
•	social media reach
•	number and type of interactions
•	social media shares
All of these numbers give insights into how an audience is responding to the marketing tactics. But behind those numbers are emotions. And emotions are the driving force behind everything a user does on social media. To fully understand how a brand is perceived online, there is a need to track social media sentiment.
